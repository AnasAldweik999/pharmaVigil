...
public class ShiftNameNotTakenByOthersValidator implements Validator<Shift> {

    private final ShiftRepository repository;

    public ShiftNameNotTakenByOthersValidator(ShiftRepository repository) {
    ...
    public Set<SystemViolation> validate(Shift shift) {
        ...
        if (repository.existsByNameIgnoreCaseAndIdNot(shift.getName(), shift.getId())) {
