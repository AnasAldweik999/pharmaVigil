...
@And({
        ...
        @Spec(params = "staffEmail", path = "staffUser.email", spec = Equal.class),
        @Spec(params = "staffName", path = "staffUser.name", spec = LikeIgnoreCase.class)
})
public interface SupervisorWorkReportFilterSpec extends Specification<WorkReportEntity> {
}
